...
### File Upload Errors
**Examples:** Unsupported file type, Corrupted file, File too large, Empty file
**Action:**
- Reject upload
...
### OCR Errors
**Examples:** OCR engine timeout, Poor image quality, Unsupported language
**Action:**
- Retry once
...
### AI Analysis Errors
**Examples:** AI service unavailable, Token limit exceeded, Response validation failed
**Action:**
...
**Examples:** Missing mandatory fields, Invalid relationships, Duplicate requirements
**Action:**
- Prevent publication
