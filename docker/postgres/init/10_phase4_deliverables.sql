...
-- Sprint 4.3 — SOW template seed (idempotent)
INSERT INTO document_templates (id, document_type, code, name, active)
...
SELECT
    ...
    '1.0.0', 1, 0, 0,
    '[
      {"section_type":"purpose","title":"Purpose"},
      {"section_type":"scope","title":"Scope"},
      {"section_type":"solution_overview","title":"Solution Overview"},
      {"section_type":"deliverables","title":"Deliverables"},
      {"section_type":"implementation_activities","title":"Implementation Activities"},
      {"section_type":"testing","title":"Testing"},
      {"section_type":"acceptance_criteria","title":"Acceptance Criteria"},
      {"section_type":"customer_responsibilities","title":"Customer Responsibilities"},
      {"section_type":"provider_responsibilities","title":"Provider Responsibilities"},
      {"section_type":"assumptions","title":"Assumptions"},
      {"section_type":"exclusions","title":"Exclusions"},
      {"section_type":"schedule","title":"Schedule"},
      {"section_type":"support_warranty","title":"Support / Warranty"},
      {"section_type":"change_control","title":"Change Control"}
    ]'::jsonb,
    '{"format":"docx"}'::jsonb,
    '{"include_draft_watermark": true}'::jsonb,
    'active'
...
-- Sprint 4.3 — Solution Design template seed (idempotent)
INSERT INTO document_templates (id, document_type, code, name, active)
...
SELECT
    ...
    '1.0.0', 1, 0, 0,
    '[
      {"section_type":"design_objectives","title":"Design Objectives"},
      {"section_type":"scope","title":"Scope"},
      {"section_type":"requirements_traceability","title":"Requirements Traceability"},
      {"section_type":"high_level_architecture","title":"High-level Architecture"},
      {"section_type":"logical_design","title":"Logical Design"},
      {"section_type":"physical_component_design","title":"Physical / Component Design"},
      {"section_type":"capacity","title":"Capacity"},
      {"section_type":"security","title":"Security"},
      {"section_type":"availability","title":"Availability"},
      {"section_type":"integration","title":"Integration"},
      {"section_type":"operations","title":"Operations"},
      {"section_type":"monitoring","title":"Monitoring"},
      {"section_type":"assumptions","title":"Assumptions"},
      {"section_type":"risks","title":"Risks"},
      {"section_type":"design_decisions","title":"Design Decisions"},
      {"section_type":"appendices","title":"Appendices"}
    ]'::jsonb,
    '{"format":"docx"}'::jsonb,
    '{"include_draft_watermark": true}'::jsonb,
    'active'
